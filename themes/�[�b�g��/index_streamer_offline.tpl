<tr class="streamer {$live} old">
  <td class="name"><span class="popup"><a href="view.php?id={$sid}" target="_blank">ゼットン{if $live_raw && $thumbnail != ''}<img class="thumb" src="{$thumbnail}" width="320" height="240" />{/if}</a></span>
