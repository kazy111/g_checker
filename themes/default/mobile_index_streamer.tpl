<tr class="streamer {$live}">
  <td class="name time"><span class="popup"><a href="view.php?id={$sid}" target="_blank">{$name}{if $live_raw && $thumbnail != ''}<img class="thumb" src="{$thumbnail}" height="240" />{/if}</a></span>
