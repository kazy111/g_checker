<tr class="streamer {$live} {if $even}even{else}odd{/if} old">
  <td class="name"><span><a href="view.php?id={$sid}" target="_blank">{$name}</a></span><span class="tags">{$tag}</span></td>
  ...
  <td class="program"><span>{$program}</span></td>
